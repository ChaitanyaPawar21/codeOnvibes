        ...
        >
            <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="fade-up mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[1, 2, 3].map((i) => (
                        <div key={i} className="bg-[var(--color-dark-surface)] border border-gray-800 rounded-xl h-64 hover:border-[var(--color-neon-blue)] transition-colors duration-500 box-glow-hover flex items-center justify-center">
